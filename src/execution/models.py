...
VALID_TRANSITIONS: dict[TradeState, set[TradeState]] = {
    TradeState.CREATED: {TradeState.VALIDATING},
    TradeState.VALIDATING: {TradeState.SUBMITTED},
    ...
    TradeState.FILLED: {TradeState.EXITS_PLACED},
    TradeState.EXITS_PLACED: {
        TradeState.TP_FILLED,
        TradeState.SL_FILLED,
        TradeState.FORCE_CLOSED,
    },
    TradeState.TP_FILLED: {TradeState.CLOSED},
    TradeState.SL_FILLED: {TradeState.CLOSED},
    TradeState.FORCE_CLOSED: {TradeState.CLOSED},
